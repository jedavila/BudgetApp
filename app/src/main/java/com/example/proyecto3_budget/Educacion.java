...
Descripcion: Clase controlador la tabla
...
public class Educacion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.educacion_layout);
        dialog=new Dialog(this);
        table = this.findViewById(R.id.tableC);
    ...
    public void startNewItem(View v){
        ...
        btnGuardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                eduController.newEducacion(descripcion, valor, fecha);
                loadTable();
                dialog.dismiss();
    ...
    private void loadTable(){
        tableController.destroy(eduController.getEducacion().size());
        eduController.getEducacion().forEach(i ->{
